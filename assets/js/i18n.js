...
const I18N = {
  it: {
    ...
    "map.filter.experience": "Esperienze",
    "map.filter.sport": "Sport",
    "map.filter.other": "Altro",
    "map.places.empty": "Stiamo aggiungendo i primi posti alla mappa — torna presto a scoprirli.",
    "map.places.noresults": "Nessun risultato in questa categoria.",
    "map.activate": "Clicca per attivare la mappa",
    "map.sort.featured": "In evidenza",
    "map.sort.latest": "Ultime",
    "map.sort.popular": "Più gettonate",
  ...
  en: {
    ...
    "map.filter.experience": "Experiences",
    "map.filter.sport": "Sport",
    "map.filter.other": "Other",
    "map.places.empty": "We're adding the first spots to the map — check back soon.",
    "map.places.noresults": "No results in this category.",
    "map.activate": "Click to activate the map",
    "map.sort.featured": "Featured",
    "map.sort.latest": "Latest",
    "map.sort.popular": "Most popular",
    ...
    "campionato.staff.title": "Management",
    "campionato.crew.title": "Staff",
